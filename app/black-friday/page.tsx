import StripeButton from "../components/StripeButtonBF";
import StripeButtonAlt from "../components/StripeButtonBFAlt";
import CountdownTimer from "../components/CountdownTimerBF";
    ...
    <main className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-sm text-charcoal/60 tracking-wide">
            Black Friday Sale • 50% Off • Ends Monday
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 text-lg leading-relaxed order-1 md:order-2">
              <div className="space-y-4">
                ...
                <p>
                  My mother is Master Yuki Tanaka (田中由紀), a third-generation
                  kintsugi artist in Kyoto.
                </p>
                <p>
                  For 30 years, she's practiced kintsugi in our family's small
                  ceramic repair studio tucked away in Kyoto's Higashiyama
                  district.
                </p>
                <p>
                  She learned from her grandmother, who learned from HER
                  grandmother. Three generations of women repairing broken
                  things with gold.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <p>
                  A woman would bring in her mother's rice bowl, cracked down
                  the middle. "Can you save it?"
                </p>
                <p className="italic">
                  My mother would hold it gently. "It's not about saving it.
                  It's about showing what it survived."
                </p>
                <p>
      ...
      <section className="py-20 px-6 bg-warmGray/30">
        <div className="max-w-4xl mx-auto space-y-8 text-lg leading-relaxed">
          ...
          <div className="space-y-4">
            <p>
              One man brought his late wife's teacup. "She used this every
              morning. I dropped it."
            </p>
            <p>
              My mother repaired it with gold so delicate it looked like morning
              light caught in the crack.
            </p>
            <p>
              He came back six months later with his daughter. "Can you teach
              her? My granddaughter wants to learn."
            </p>
          </div>
          ...
          <div className="space-y-4">
            <p>
              My mother only taught tourists who found our studio by accident. A
              few students at a time, sitting at the long wooden table, learning
              in broken Japanese and hand gestures.
            </p>
          ...
          <div className="space-y-4">
            <p className="font-medium">
              "Okaasan, you've taught hundreds of people in person. Why not
              teach online? Why not share this with people who'll never make it
              to Kyoto?"
            </p>
            <p>
              She was hesitant. "Can you really teach wabi-sabi through a
              screen?"
            </p>
            <p>But we tried.</p>
          </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-8 text-lg leading-relaxed">
            ...
            <p className="font-medium pt-8 text-xl text-center">
              My mother always teaches: "The bowl is more beautiful for having
              been broken."
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2 text-charcoal/80">
                    <li>
                      • Complete materials list with exact product links
                    </li>
                    <li>
                      • Food-safe epoxy alternatives instead of traditional
                      urushi lacquer
                    </li>
                    <li>
                      • The 3 types of breaks and which technique to use for
                      each
                    </li>
      ...
      <section id="pricing-section" className="py-32 px-6 bg-warmGray/30">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <p className="text-lg text-charcoal/70 tracking-wide font-medium">
            38 of 50 early access spots remaining
          </p>
          ...
          <div className="py-8">
            ...
            <p className="text-sm text-charcoal/60">
              Black Friday pricing • Ends Cyber Monday
            </p>
          </div>

          <div className="max-w-lg mx-auto text-left bg-cream/50 rounded-lg p-6 mb-4">
            <p className="font-medium mb-3">As an early access student, you get:</p>
            <ul className="space-y-2 text-charcoal/80 text-sm">
              <li>• Instant access to the digital book with step-by-step instructions</li>
              <li>• Enhanced update with more photos and clearer examples at no cost to you (in 2-3 weeks)</li>
              <li>• Exclusive early pricing on video lessons + authentic kit</li>
            </ul>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-warmGray/50 rounded-lg p-8">
            <p className="text-lg italic mb-4">
              "I was so stressed at work I could barely sleep. Kintsugi became
              my evening meditation. Now I have 6 repaired pieces on my shelf
              and friends asking me to teach them. This changed how I spend my
              evenings."
            </p>
          ...
          <div className="bg-warmGray/50 rounded-lg p-8">
            <p className="text-lg italic mb-4">
              "Someone offered me $180 for a piece I repaired from a $3 thrift
              store find. But honestly? I kept it. The money isn't why I do
              this. It's the only hobby I've stuck with because it actually
              feels meaningful."
            </p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-cream rounded-lg p-6">
              ...
              <p className="mt-4 text-charcoal/80">
                Expect to spend $30-50 for your complete starter kit. This
                includes everything: epoxy resin, gold powder, brushes, mixing
                tools, sealant. These materials will last for 10+ repairs. We
                provide exact shopping links so you don't waste money on the
                wrong supplies.
              </p>
            </details>
            ...
            <details className="bg-cream rounded-lg p-6">
              ...
              <p className="mt-4 text-charcoal/80">
                Yes. My mother believes strongly that kintsugi should be shared,
                not gatekept. This is a craft meant to repair and create beauty
                - it doesn't belong only to Japan. She's been teaching
                international students for 30 years. The only requirement is
                that you approach it with respect for the philosophy behind it.
                If you're worried about this, that respect is already there.
              </p>
            </details>
            ...
            <details className="bg-cream rounded-lg p-6">
              ...
              <p className="mt-4 text-charcoal/80">
                ...
                (after proper sealing, which we teach in Module 5). My mother
                has repaired teacups that have been used daily for 20+ years.
              </p>
            </details>

            <details className="bg-cream rounded-lg p-6">
              <summary className="font-medium cursor-pointer text-lg">
                Is the repair food-safe?
              </summary>
              <p className="mt-4 text-charcoal/80">
                Yes. The epoxy we recommend is food-safe once fully cured (24-72 hours depending on the product). We cover proper curing times and sealing techniques in the guide. You'll be able to drink from your repaired teacups and eat from your repaired bowls safely.
              </p>
            </details>
