...
function FullCTASection({ showTimer = true }: { showTimer?: boolean }) {
 ...
 <p className="text-center text-charcoal text-xl md:text-2xl font-medium">
 ⭐ Join 373+ students already learning ⭐
 </p>
...
export default function CreatePage() {
 ...
 {/* Hero Section - Simple headline + gallery */}
 ...
 Dazzling Golden Heirlooms (Learn In 2 Hours & $16 In Materials)
 </h1>
 ...
 <div className="aspect-square rounded-lg overflow-hidden shadow-lg">
 <Image
 src="/kintsugi_imgs/kintsugihero.webp"
 alt="Kintsugi example"
 width={400}
 height={400}
 className="w-full h-full object-cover"
 ...
 <p className="text-xl md:text-2xl text-center text-charcoal/80 mb-16 font-bold">
 All you need is <strong>$16 in materials</strong> you can get off Amazon (you&apos;ll get exact links)
 </p>
 ...
 <ul className="space-y-2 text-lg md:text-xl text-charcoal/80">
 <li>• Complete shopping list with exact product links (under $16 total)</li>
 ...
 {/* What You Get - Big emoji features */}
 ...
 <p className="text-2xl md:text-3xl">
 <span className="text-3xl md:text-4xl">🛡️</span> 90 Day Money Back Guarantee
 </p>
 </div>
 </div>
 </section>

 {/* Social Proof - FB Comments */}
 ...
 <ul className="space-y-2 text-lg md:text-xl text-charcoal/80">
 <li>• <strong>Photography tips</strong> for showing the gold</li>
 <li>• <strong>How to talk about your work</strong></li>
 <li>• <strong>Teaching kintsugi</strong> to friends</li>
 </ul>
 </div>
 </div>
 </div>
 ...
 <ul className="space-y-2 text-lg md:text-xl text-charcoal/80">
 <li>• <strong>Breathwork</strong> while repairing</li>
 <li>• <strong>Entering flow state</strong></li>
 <li>• <strong>Journaling prompts</strong> on beauty & brokenness</li>
 </ul>
 </div>
 </div>
 </div>
 ...
 <ul className="space-y-2 text-lg md:text-xl text-charcoal/80">
 <li>• <strong>10 best thrift store finds</strong> under $5</li>
 <li>• <strong>Gift presentation ideas</strong></li>
 <li>• <strong>Repair timeline</strong> for any occasion</li>
 </ul>
 </div>
 </div>
 </div>
 ...
 Online. You get instant access to stream all video lessons on
 any device—phone, tablet, or computer. Watch at your own pace,
 rewind as needed, and learn from home.
 </p>
 </details>
 ...
 <p className="mt-4 text-lg md:text-xl text-charcoal/80 leading-relaxed">
 Forever. You get lifetime access. Watch anytime you want—you
 don&apos;t have to start now if you&apos;re busy. Start at your
 convenience. The course will always be there waiting for you.
 </p>
 </details>
 ...
 costs under $16 and produces the same stunning golden result.
 ...
 alt="Yuki holding a kintsugi bowl"
 width={224}
 height={224}
 ...
 $16, not $200 or more. Everything you need to start your first
 repair.
 </p>
 </div>
 </div>
 ...
 {/* Final CTA - Quote only, no headline */}
