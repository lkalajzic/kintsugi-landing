...
export default function KitUpsell() {
  ...
  const paymentLinks = {
    bundle: "https://buy.stripe.com/28E9AU3ia5nt1NTdzI43S03",
    video: "https://buy.stripe.com/4gM5kEf0S4jpdwB2V443S04",
    kit: "https://buy.stripe.com/fZucN66um3flbotbrA43S05",
  };
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg leading-relaxed mb-16">
            <p>
              Master Yuki's complete video lessons are ready: 8 detailed lessons
              showing every technique, close-up, from her Kyoto studio.
            </p>
            <p>
              We've also sourced kintsugi materials with everything you need in
              one kit that ship directly to you.
            </p>
            <p>
              Most students like to get both. They watch Yuki's hands, then
          ...
          <div className="max-w-2xl mx-auto space-y-4 mb-12">
            ...
            >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-2xl font-light text-gold">$97</p>
                  </div>
            ...
            >
                <div className="mb-3">
                  <p className="text-xl font-medium text-charcoal mb-1">
                    Just the Video Lesssons
                  </p>
                  <p className="text-2xl font-light text-charcoal">$79</p>
                </div>
            ...
            >
                <div className="mb-3">
                  ...
                  <p className="text-2xl font-light text-charcoal">$59</p>
                </div>
                <div className="text-charcoal/80">
                  <p>✓ Kintsugi Kit With Everything You Need</p>
                  <p>
