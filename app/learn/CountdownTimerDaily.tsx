...
export default function CountdownTimerDaily() {
  ...
  useEffect(() => {
    ...
    const getNextReset = () => {
      ...
      // Zagreb is UTC+1 (CET) in winter, UTC+2 (CEST) in summer
      ...
      // If we're past today's reset, target tomorrow's reset
      if (now >= todayReset) {
