          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside text-charcoal/80 space-y-2">
                <li>
                  <a href="https://amzn.to/495g2ma" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">ATLASBOND Ceramic Glue</a> - Food safe, quick-setting
                </li>
                <li>
                  <a href="https://amzn.to/4pkLYYi" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Puduo Epoxy Resin Kit</a> - Crystal clear, includes cups, sticks & gloves
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-charcoal/80 space-y-2">
                <li>
                  <a href="https://amzn.to/4quOa0s" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">MEYSPRING Royal Gold Mica</a> - Most popular for kintsugi, cosmetic grade
                </li>
                <li>
                  <a href="https://amzn.to/4qAo6kr" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Gold Mica Powder Set</a> - Great value option
                </li>
                <li>
                  <a href="https://amzn.to/4qyHmin" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Alternative Gold Powder</a> - High quality option
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-charcoal/80 space-y-2">
                ...
                <li>
                  <a href="https://amzn.to/3N0wETs" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Masking Tape</a> - To hold pieces in place while drying
                </li>
                <li>
                  <a href="https://amzn.to/4pjVGKs" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Masking Tape (alternative)</a> - Another good option
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-charcoal/80 space-y-2">
                <li>
                  <a href="https://amzn.to/4seSu5E" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Fine Brush Set</a> - Only needed for hairline cracks
                </li>
                <li>
                  <a href="https://amzn.to/49Be1hE" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Sandpaper</a> - Fine grit (400-600) for smoothing dried epoxy
                </li>
                <li>
                  <a href="https://amzn.to/4qz0SLJ" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Acetone</a> - For cleaning up mistakes before epoxy sets
                </li>
                <li>
                  <a href="https://amzn.to/3LnTZhn" target="_blank" rel="noopener noreferrer" className="text-amber-900 hover:text-amber-950 underline font-medium">Rubbing Alcohol 99%</a> - Alternative cleaner, evaporates fast
                </li>
              </ul>
            </div>
          </div>
