  ...
  return (
    <main className="min-h-screen bg-cream py-16 px-6">
      <article className="max-w-3xl mx-auto prose prose-neutral">
        ...
        <p>We sell digital educational products including online courses, digital guides, and downloadable materials. These are delivered electronically—no physical products are shipped.</p>
