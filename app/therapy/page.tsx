...
export default function TherapyPage() {
 ...
 Kintsugi: The 500-Year-Old Art Therapists Are Learning For
 Themselves
 </h1>
 ...
 <p className="text-lg leading-relaxed">
 Not "self-care" that's really just errands. Not scrolling.
 </p>
 <p className="text-lg leading-relaxed">
 When was the last time you made something with your hands and felt
 completely present?
 </p>
 </div>
 ...
 After A Full Caseload
 </h2>

 <div className="space-y-4">
 <p>Sometimes the last thing you want is more words.</p>
 <p>More processing. More screens. More holding.</p>
 <p>
 You might already use kintsugi as a metaphor with clients. The
 cracks don't mean you're broken - they become part of what makes
 you beautiful.
 </p>
 <p className="font-medium">
 But there's something different about actually doing it.
 </p>
 </div>

 <h3 className="text-2xl md:text-3xl font-light pt-8 text-center">
 Quiet. Meditative. Absorbing.
 </h3>
 ...
 <p>Just your hands, broken pieces, and gold.</p>
 <p className="font-medium">
 No notes. No documentation. No one else's nervous system.
 </p>
 </div>
 </div>
 </section>
 ...
 <p>
 What struck me wasn't only the craft. It was watching what happens
 to people while they work.
 </p>
 <p>
 Something shifts. The phone stays in the bag. The mental chatter
 quiets. There's just the piece, the gold, and the breath.
 </p>
 <p>
 ...
 <div className="max-w-4xl mx-auto space-y-8 text-lg leading-relaxed">
 <h2 className="text-3xl md:text-4xl font-light text-center mb-8">
 Why I'm Teaching This Online
 </h2>

 <div className="space-y-4">
 <p>
 Most people can't spend thousands of dollars to travel to Japan.
 They'll never sit in a studio with a master. Never experience the
 meditative practice of repairing something broken with gold.
 </p>
 <p>
 ...
 $30. Everything you need to start your first repair.
 </p>
 <p>
 You can learn at your own pace. In your own space. Whenever you
 have time.
 </p>
 </div>
 </div>
 ...
 <p>
 The Japanese philosophy of finding beauty in imperfection and
 impermanence. Embracing asymmetry, roughness, and the marks of
 weathering as elements that deepen character rather than
 diminish it.
 </p>
 <p className="font-medium">Kintsugi is wabi-sabi made visible.</p>
 <p className="italic">
 ...
 <div className="space-y-4 pt-6">
 <h3 className="text-2xl font-light">More Than A Metaphor</h3>
 <p>
 You may have used kintsugi as a metaphor before. The idea that
 our breaks and scars don't diminish us - they become part of
 what makes us who we are.
 </p>
 <p>
 There's something different about doing it with your hands.
 Feeling the weight of the pieces. Watching the gold fill the
 cracks. Creating something beautiful from something broken.
 </p>
 <p className="italic">
 The metaphor becomes embodied. The concept becomes real.
 </p>
 </div>
 ...
 <p className="text-charcoal/70 mb-4">
 Deepen the meditative practice
 </p>
 <ul className="space-y-2 text-sm text-charcoal/80 mb-4">
 ...
 requires patience, not perfection - and wabi-sabi reminds us
 that imperfection is part of the beauty.
 </p>
 </details>
 ...
 work spread over a few days. Many people find the pace is part
 of what makes it meditative - you work in the evening, let it
 dry overnight, continue the next day.
 </p>
 </details>

 <details className="bg-cream rounded-lg p-6">
 <summary className="font-medium cursor-pointer text-lg">
 Will the repair be strong enough to use the piece again?
 </summary>
 <p className="mt-4 text-charcoal/80">
 ...
 class. Do your first repair. If you don't absolutely love it,
 just email us within 90 days and we'll refund you in full. No
 ...
 <p className="text-lg text-charcoal/70">— Yuki</p>
